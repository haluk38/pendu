let arrWord = ["pirate", "poisson", "bateau", "autruche", "crocodile"]
let findedWord = ""
...
function gameOver() {
        document.querySelector("#win").innerHTML = "Vous avez perdu !!! <button onclick='prepareGame()'>Rejouer</button>"
...
function checkWin() {
    if (hidden.toLowerCase() == findedWord) {
        ...
        document.querySelector("#win").innerHTML = "Vous avez Gagné !!! <button onclick='prepareGame()'>Rejouer</button>"
    }
}
